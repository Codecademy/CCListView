...
- (UIScrollView *)contentViewAsScrollView
{
    UIScrollView *result;
...
- (CGPoint)insertPointOfContentViewAtIndex:(NSUInteger)index
{
    ...
    if ( [self contentViewAsScrollView] )
    {
        CGPoint offset = [self contentViewAsScrollView].contentOffset;
